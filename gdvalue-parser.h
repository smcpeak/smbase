...
public:      // methods
  ...
  bool isTaggedTupleSize(char const *tag, GDVSize size) const;
...
// Populate a GDVSymbol specifically.
template <>
struct GDVPTo<GDVSymbol> {
  static GDVSymbol f(GDValueParser const &p);
};
