...
SRCS += gdv-symbol.cc
SRCS += gdv-tuple.cc
SRCS += gdvalue-fnapply-transform.cc
SRCS += gdvalue-json.cc
SRCS += gdvalue-kind-srcloc.cc
SRCS += gdvalue-parser.cc
SRCS += gdvalue-reader.cc
SRCS += gdvalue-srcloc-mgr.cc
SRCS += gdvalue-srcloc.cc
SRCS += gdvalue-subst-transform.cc
SRCS += gdvalue-transform.cc
...
SRCS += parsestring.cc
SRCS += point.cc
SRCS += portable-error-code.cc
SRCS += posix-fd-ostream.cc
SRCS += pp-file-line.cc
SRCS += pprint.cc
...
SRCS += utf8-writer.cc
SRCS += vdtllist.cc
SRCS += virtual-address-space.cc
SRCS += voidlist.cc
SRCS += vptrmap.cc
SRCS += warn.cc
SRCS += windows-handle-ostream.cc
SRCS += xarithmetic.cc
SRCS += xoverflow.cc
...
UNIT_TEST_OBJS += buffered-streambuf-test.o
UNIT_TEST_OBJS += c-string-reader-test.o
UNIT_TEST_OBJS += chained-cond-test.o
...
UNIT_TEST_OBJS += file-line-col-test.o
UNIT_TEST_OBJS += functional-set-test.o
UNIT_TEST_OBJS += gcc-options-test.o
UNIT_TEST_OBJS += gdv-binary64-float-test.o
UNIT_TEST_OBJS += gdv-symbol-test.o
UNIT_TEST_OBJS += gdv-tuple-test.o
UNIT_TEST_OBJS += gdvalue-fnapply-transform-test.o
UNIT_TEST_OBJS += gdvalue-json-test.o
UNIT_TEST_OBJS += gdvalue-kind-srcloc-test.o
UNIT_TEST_OBJS += gdvalue-parser-test.o
UNIT_TEST_OBJS += gdvalue-reader-test.o
UNIT_TEST_OBJS += gdvalue-srcloc-mgr-test.o
UNIT_TEST_OBJS += gdvalue-srcloc-test.o
UNIT_TEST_OBJS += gdvalue-subst-transform-test.o
UNIT_TEST_OBJS += gdvalue-test.o
UNIT_TEST_OBJS += gdvalue-transform-test.o
UNIT_TEST_OBJS += gdvalue-writer-test.o
...
UNIT_TEST_OBJS += line-col-test.o
...
UNIT_TEST_OBJS += portable-error-code-test.o
UNIT_TEST_OBJS += posix-fd-ostream-test.o
UNIT_TEST_OBJS += pp-file-line-test.o
...
UNIT_TEST_OBJS += safe-int-conv-test.o
...
UNIT_TEST_OBJS += sm-intcmp-test.o
...
UNIT_TEST_OBJS += sm-test-test2.o
...
UNIT_TEST_OBJS += std-tuple-fwd-test.o
...
UNIT_TEST_OBJS += string-reader-test.o
...
UNIT_TEST_OBJS += virtual-address-space-test.o
