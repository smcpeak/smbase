...
OldSmbaseString translate(rostring src, rostring srcchars, rostring destchars);
...
OldSmbaseString trimWhitespace(rostring str);
// dsw: get the first alphanum token in the string
OldSmbaseString firstAlphanumToken(rostring str);
...
OldSmbaseString encodeWithEscapes(char const *src, int len);

// Overloads for the other variants of 'char'.
inline OldSmbaseString encodeWithEscapes(unsigned char const *src, int len)
  { return encodeWithEscapes((char const *)src, len); }
inline OldSmbaseString encodeWithEscapes(signed char const *src, int len)
  { return encodeWithEscapes((char const *)src, len); }

// safe when the text has no NUL characters
OldSmbaseString encodeWithEscapes(rostring src);
